...
public class ChooseLaboratoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chooselaboratory);
    ...
    protected void onStart() {
        ...
        databaseLabs.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new LaboratoriesList(ChooseLaboratoryActivity.this, labList);
