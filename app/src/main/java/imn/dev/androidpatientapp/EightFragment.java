...
public class EightFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_eight, null);

        Button btnavail = (Button) view.findViewById(R.id.btnavail);
        btnavail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String serviceName = "Basic Sports Clearance Package";
                String serviceDesc = "Complete Blood Count, Routine Urinalysis, Stool Exam/Fecalysis";
                String servicePrice = "300";
