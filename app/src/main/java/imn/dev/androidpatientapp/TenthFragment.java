...
public class TenthFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_tenth, null);

        Button btnavail = (Button) view.findViewById(R.id.btnavail);
        btnavail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String serviceName = "Diabetes Awareness Package";
                String serviceDesc = "Magic 8(Cholestero, HDL, LDL, VLDL, Triglycerides, Creatinine, BUN, FBS, HbA1c, Urinalysis, Sodium, Potassium";
                String servicePrice = "2150";

                Intent intent = new Intent(getActivity(), ChooseLaboratory2Activity.class);
