...
public class SeventhFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_seventh, null);

        Button btnavail = (Button) view.findViewById(R.id.btnavail);
        btnavail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String serviceName = "Pre-Employment Package 2";
                String serviceDesc = "Complete Blood Count, Fasting Blood Sugar, Routine Urinalysis, Routine Fecalysis, Blood Typing, Drug Test";
                String servicePrice = "1125";
